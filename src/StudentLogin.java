...
public class StudentLogin extends JFrame {
	...
	public StudentLogin() {
		...
		JLabel lblEnterName = new JLabel("Enter RollNo:");
		...
		btnLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(textField.getText() == "" || String.valueOf(passwordField.getPassword()) == "") {
					JOptionPane.showMessageDialog(StudentLogin.this, "Input Fields can't be empty","Login Status", JOptionPane.ERROR_MESSAGE);
					textField.setText("");
				...
				boolean status = StudentDoe.login(rollno, password);
				if(status){
					StudentSuccess.main(new String[]{rollno});
					frame.dispose();
				}else{
		...
		btnSignUp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				StudentSignUpForm.main(new String[] {});
				frame.dispose();
			}			
		});
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addComponent(lblOr, GroupLayout.PREFERRED_SIZE, 22, GroupLayout.PREFERRED_SIZE)
					.addGap(182))
		);
