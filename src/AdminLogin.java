...
public class AdminLogin extends JFrame {
	...
	public AdminLogin() {
		...
		btnLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(textField.getText() == "" || String.valueOf(passwordField.getPassword()) == "") {
					JOptionPane.showMessageDialog(AdminLogin.this, "Input Fields can't be empty","Login Status", JOptionPane.ERROR_MESSAGE);
					textField.setText("");
					passwordField.setText("");
				}
				String name=textField.getText();
				String password=String.valueOf(passwordField.getPassword());
				boolean status = AdminDoe.login(name, password);
				if(status){
		...
		btnSignUp.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AdminSignUpForm.main(new String[] {});
				frame.dispose();
			}			
		});
